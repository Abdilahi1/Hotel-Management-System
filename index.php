		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Damal <span>Hotel </span><p class="logo_w3l_agile_caption">Your Dreamy Hotel</p></a></h1>
				</div>
						...
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4>Damal Hotel</h4>
										...
										<p>your stay will be memorable </p>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>Damal <span>Hotel</span></h4>
										<!-- <img src="images/Aj3.jpg" alt=" " class="img-responsive"> -->
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Damal Hotel</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Damal Hotel</h3> 
						   ...
						   <img src="images/Aj1.jpg" class="img-responsive" alt="Hair Salon">
										<div class="w3l-slider-img">
											<!-- <img src="images/Aj1.jpg" class="img-responsive" alt="Hair Salon"> -->
										</div>
                                       <div class="w3ls-info-about">
										    <h4>You'll love all the amenities we offer!</h4>
											<p>Damal is five star Hotel </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+252 (63) 4455667</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:Damal@hotel.com">Damal@hotel.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Hargeisa Roud no.1,Somaliland </p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2023 DAMAL HOTEL . All Rights Reserved | Design by <a href="index.php">Damal Hotel</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
